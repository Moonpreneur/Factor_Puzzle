...
LevelSelectView.prototype.drawLevelResults = function (value) {
  ...
  if (number === 1) {
      ...
      result = number < 10 ? 'LOW!' : '';
  }

  this.brush.fillStyle = this.theme.sliderColor;
  this.brush.font = 'bold ' + this.blockSize * 0.5 + 'px "Trebuchet MS", sans-serif';
...
LevelSelectView.prototype.drawNumber = function (value, blockColor) {
  ...
  this.brush.fillRect((this.renderRegion.width / 2) - (this.blockSize / 2), this.renderRegion.height * 0.15, this.blockSize, this.blockSize);
  ...
  this.brush.fillText('' + value, this.renderRegion.width / 2, (this.renderRegion.height * 0.15) + (this.blockSize / 2));
};
...
LevelSelectView.prototype.drawButton = function (color) {
  this.brush.fillStyle = color;
  this.brush.fillRect(this.xPad, this.renderRegion.height * 0.75, this.renderRegion.width - this.xPad * 2, this.renderRegion.height * 0.15);
  this.brush.font = 'bold ' + this.blockSize * 0.5 + 'px "Trebuchet MS", sans-serif';
  this.brush.fillStyle = this.theme.numberColor;
  this.brush.fillText('Play', this.renderRegion.width / 2, this.renderRegion.height * 0.75 + this.renderRegion.height * 0.075);
};

LevelSelectView.prototype.getButtonBoundingBox = function () {
  return new BoundingBox(this.xPad / 2, this.renderRegion.height * 0.75, this.renderRegion.width - this.xPad, this.renderRegion.height * 0.15);
};
...
LevelSelectView.prototype.draw = function (value, x, y, end) {
  ...
  this.brush.font = 'bold ' + this.blockSize * 0.25 + 'px "Trebuchet MS", sans-serif';
  this.brush.fillStyle = this.theme.sliderColor;
